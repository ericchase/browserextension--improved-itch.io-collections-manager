...
import { Async_Core_Map_Get_Or_Default } from './ericchase/Core_Map_Get_Or_Default.js';
...
export async function async_createGamePageCollectionsManager(game_id: string) {
...
export async function async_showGamePageCollectionsManager(ul_user_tools: HTMLUListElement, game_id: string) {
  const div_manager = await Async_Core_Map_Get_Or_Default(game_id_to_manager_map, game_id, async () => {
